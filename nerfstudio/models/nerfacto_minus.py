...
from nerfstudio.fields.nerfacto_minus_field import TCNNNerfactoMinusField
...
@dataclass
class NerfactoMinusModelConfig(ModelConfig):
    """Nerfacto Minus Model Config"""

    _target: Type = field(default_factory=lambda: NerfactoMinusModel)
...
class NerfactoMinusModel(Model):
    """Nerfacto model without appearance embedding
    ...
    def populate_modules(self):
        ...
        # Fields
        self.field = TCNNNerfactoMinusField(
            self.scene_box.aabb,
