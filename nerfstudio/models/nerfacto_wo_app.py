...
from nerfstudio.fields.nerfacto_field_wo_app import TCNNNerfactoField
...
@dataclass
class NerfactoWoAppModelConfig(ModelConfig):
    """Nerfacto without appearance embedding Model Config"""

    _target: Type = field(default_factory=lambda: NerfactoWoAppModel)
...
class NerfactoWoAppModel(Model):
