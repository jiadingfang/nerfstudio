...
"""
Bayes NeRF implementation that combines many recent advancements.
"""
...
from nerfstudio.fields.bayes_nerf_field import TCNNBayesNeRFField
...
@dataclass
class BayesNeRFModelConfig(ModelConfig):
    """BayesNeRF Model Config"""

    _target: Type = field(default_factory=lambda: BayesNeRFModel)
...
class BayesNeRFModel(Model):
    """Bayes NeRF model

    Args:
        config: Bayes NeRF configuration to instantiate model
    """

    config: BayesNeRFModelConfig
    ...
    def get_loss_dict(self, outputs, batch, metrics_dict=None):
        ...
        loss_dict["rgb_loss"] = ((image - outputs["rgb"]) ** 2 / (betas ** 2 * 2)).mean()
    ...
    def get_image_metrics_and_images(
        ...
        images_dict["uncertainty"] = outputs["uncertainty"]
