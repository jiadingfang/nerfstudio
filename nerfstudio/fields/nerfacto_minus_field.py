...
class TCNNNerfactoMinusField(Field):
...
class TorchNerfactoMinusField(Field):
    """
...
field_implementation_to_class = {"tcnn": TCNNNerfactoMinusField, "torch": TorchNerfactoMinusField}
